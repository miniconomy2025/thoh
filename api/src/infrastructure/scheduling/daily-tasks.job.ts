...
export const SIM_DAY_INTERVAL_MS = 2 * 60 * 1000; // 2 minutes in ms

// This would be called by a scheduler (e.g., node-cron or setInterval)
export function runDailyTasks(advanceDayUseCase: AdvanceSimulationDayUseCase, simulationId: number, marketId: number) {
